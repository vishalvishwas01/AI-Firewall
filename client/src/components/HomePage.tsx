    ...
    <div className="mx-auto grid min-h-[calc(100vh-4rem)] max-w-[1280px] items-center gap-12 px-6 py-16 sm:px-8 lg:grid-cols-[0.92fr_1.08fr] lg:px-12 xl:px-16">
      <motion.div initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.55, ease: "easeOut" }} className="relative z-10 max-w-2xl">
        ...
        <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
          <a href="#how-it-works" className="inline-flex min-h-12 items-center justify-center gap-2 rounded-lg bg-[#33312b] px-6 py-3 text-sm font-semibold text-white shadow-sm transition hover:bg-[#49483f]">See how it works <ArrowRight className="h-4 w-4" /></a>
...
function BrowserDemo() {
  return <div className="relative mx-auto max-w-[620px]">
    ...
    <div className="relative -mt-20 ml-auto w-[92%] rounded-[20px] border border-[#e2c7a1] bg-[#fffaf0] shadow-[0_24px_70px_rgba(51,49,43,0.20)] sm:w-[86%]">
      <div className="flex items-start justify-between gap-4 border-b border-[#eadcc8] p-5"><div><div className="flex items-center gap-2"><CircleAlert className="h-5 w-5 text-[#a51d22]"/><p className="font-[Manrope] text-lg font-semibold text-[#2f312f]">Sensitive secret detected</p></div><p className="mt-1 text-sm leading-5 text-[#4a463f]">This looks like it contains a key, token, password, or private secret.</p></div><span className="rounded-full bg-[#ffdad6] px-3 py-1 text-xs font-semibold text-[#93000a]">HIGH RISK</span></div>
