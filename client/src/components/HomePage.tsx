...
function Setup() {
  return <section id="setup" className="home-grid border-y border-[#ccc6bc]/60 bg-[#efeeeb] px-6 py-24 sm:px-8 lg:px-12"><div className="relative z-10 mx-auto max-w-[1000px] text-center"><div className="mx-auto flex h-14 w-14 items-center justify-center rounded-2xl bg-[#33312b] text-white"><ShieldCheck className="h-7 w-7"/></div><h2 className="mt-7 font-[Manrope] text-3xl font-semibold tracking-[-0.02em] text-[#33312b] sm:text-4xl">Extension setup is coming next.</h2><p className="mx-auto mt-4 max-w-2xl text-base leading-7 text-[#4a463f]">This area is reserved for the final Chrome Web Store installation and connection flow. Until deployment details are ready, no misleading install action is shown.</p><div className="mx-auto mt-8 min-h-14 max-w-md rounded-xl border border-dashed border-[#7b776e]/50 bg-white/40"/></div></section>;
}
